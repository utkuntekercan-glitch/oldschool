...
def init_db(conn: DBConn):
    ...
    conn.execute("CREATE INDEX IF NOT EXISTS idx_expense_d_source ON expense(d, source);")
    conn.execute("CREATE INDEX IF NOT EXISTS idx_expense_d_source_note ON expense(d, source, note);")
    conn.execute("CREATE INDEX IF NOT EXISTS idx_expense_d_category ON expense(d, category);")
